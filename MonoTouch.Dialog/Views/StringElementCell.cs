	...
	public class StringElementCell : UITableViewCell
	{
		...
		public override void LayoutSubviews ()
		{
			...
			if (_showBadge){
				...
				BadgeLabel.Frame = new RectangleF(this.ContentView.Frame.Width-size.Width-22, this.ContentView.Frame.Height/2-((size.Height+4)/2), size.Width+16, size.Height+4);
			}
		}
	}
}
